...
FROM odk_prod."LEGEND_L_V2_CORE" LEFT JOIN odk_prod."LEGEND_L_V2_RECIBO_IMAGE_BN" ON odk_prod."LEGEND_L_V2_CORE"."_URI"  = "LEGEND_L_V2_RECIBO_IMAGE_BN"."_PARENT_AURI"

WHERE "LEGEND_L_V2_CORE"."_URI" NOT IN (SELECT key from form_l_registrar_parcela);	
...
FROM public.form_l_registrar_pontos) AND 
"LEGEND_L_V2_PONTOS"."_URI" not in (SELECT key FROM public.form_l_registrar_pontos);
...
WHERE 
  ...
  CONCAT("LEGEND_L_V2_NOVAS_PESSOAS1"."LG5_TESTEM_APP"||"LEGEND_L_V2_NOVAS_PESSOAS1"."LG5_TESTEM_NOM"||"LEGEND_L_V2_NOVAS_PESSOAS1"."LG7_TESTEM_DOC"||"LEGEND_L_V2_NOVAS_PESSOAS1"."LG7_TESTEM_ID") NOT IN (SELECT key_test FROM form_l_novas_pessoas) ;
